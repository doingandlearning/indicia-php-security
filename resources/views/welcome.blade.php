...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
                        ...
                        <a href="/day1"
                            ...
                            <div
                                ...
                                <svg height="800px" width="800px" version="1.1" id="Capa_1"
                                    ...
                                    viewBox="0 0 14.461 14.461" xml:space="preserve">
                                    <g>
  ...
  c0.094,0.04,0.247,0.075,0.46,0.108C8.822,9.811,8.98,9.83,9.086,9.833v0.384H9.087z" />
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Day 1</h2>
                                <h1>Welcome to Laravel PHP Security</h1>
                                <p class="mt-4 text-sm/relaxed">
                                    Coupled with the notes and slides these exercises will allow you to put into
                                    practice all the things we've learnt.
                                </p>
                            </div>
                        ...
                        <a href="/day2"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Day 2</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    We'll look at incident response, fuzz testing and SQL injection.
                                </p>
                            </div>
                        ...
                        <a href="/day3"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Day 3</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    We'll look at data protection, auditing and compliance, CSRF and general Laravel
                                    points.
                                </p>
                            </div>
