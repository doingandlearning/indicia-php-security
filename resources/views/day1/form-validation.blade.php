    ...
    <form action="/day1/form-validation" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="mb-4">
            ...
            <input
                ...
                id="name" name="name" type="text" required value="{!! request()->get('age') !!}">
            @error('name')
        ...
        <div class="mb-4">
            ...
            <textarea
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="worried" name="worried" type="worried" required value="{!! request()->get('description') !!}">
            </textarea>
        </div>
...
{{-- /comments?order=<script>console.log('Boom!')<script> --}}
